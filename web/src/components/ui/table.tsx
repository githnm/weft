...
// Dense table, thin row separators. Numeric/id columns should be set
// `font-mono` + `text-right` by the caller.
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn("border-b border-border-subtle transition-colors hover:bg-muted/60", className)}
    {...props}
  />
));
